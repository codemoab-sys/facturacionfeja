...
App.itemsTableHTML = function (items, moneda) {
  ...
  var rows = items.map(function (it, idx) {
    ...
    return '<tr>'
      + '<td><input class="input-inline" data-field="descripcion" data-idx="' + idx + '" value="' + App.escapeHtml(it.descripcion || '') + '" />'
      ...
      + '<td><input type="number" min="0" step="any" class="input-inline text-right" data-field="cantidad" data-idx="' + idx + '" value="' + (it.cantidad == null ? '' : it.cantidad) + '" /></td>'
      + '<td><input type="number" min="0" step="any" class="input-inline text-right" data-field="precio_unitario" data-idx="' + idx + '" value="' + (it.precio_unitario == null ? '' : it.precio_unitario) + '" /></td>'
