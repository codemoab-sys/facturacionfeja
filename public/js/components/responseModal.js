...
(function () {
  App.ResponseModal = class ResponseModal {
    ...
    _html() {
      ...
      return '<div class="fixed inset-0 flex items-center justify-center z-50 p-4" style="background: rgb(15 23 42 / 0.6); backdrop-filter: blur(4px);">'
    ...
    _errorHTML() {
      ...
      var errorsBlock = (this.error && this.error.errors)
        ...
        : '';
      return '<div style="flex: 1; display: flex; flex-direction: column; align-items: center; justify-content: center; padding: 2rem; text-align: center; gap: 0.75rem;">'
