...
INSERT IGNORE INTO users (usuario, password, nombre) VALUES ('demo', '$2y$10$wQ4y.Hvp6utV59Wk9L.4BenXx8UA33BLsqxqieifz4RVJI4GnejYi', 'Usuario Demo');

-- Seed: API keys demo (vacío — configurar desde la interfaz)
INSERT IGNORE INTO user_configs (user_id, base_url, api_key, api_secret) VALUES (1, '', '', '');
